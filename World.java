...
public class World {
            ...
            while ((text = br.readLine()) != null) {
                ...
                switch (words[0]) {
                    ...
                    case "command_centre":
                        ...
                        break;
                    case "metal_mine":
                        metalMineList.add(new MetalMine(camera, Integer.parseInt(words[1]), Integer.parseInt(words[2]), 500));
                        totalmm += 500;

                        break;
                    case "unobtainium_mine":
                        unobtainiumMineList.add(new UnobtainiumMine(camera, Integer.parseInt(words[1]), Integer.parseInt(words[2]),50));
                        totalum += 50;
                }
            }
        } catch (Exception e) {
    ...
    public World() throws SlickException {
        ...
        factory = new Factory(camera, 600, 1000, false);
        factory2 = new Factory(camera, 800, 1000, false);
    ...
    public void render(Graphics g) {
        ...
        g.drawString("Metal: <" + totalmm + ">\nUnobtainium: <" + totalum + ">", 32, 32);
